...
var require_main = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports2, module2) {
    ...
    function parse(src) {
      ...
      let match;
      while ((match = LINE.exec(lines2)) != null) {
        const key = match[1];
        let value = match[2] || "";
        value = value.trim();
  ...
  "node_modules/asynckit/parallel.js"(exports2, module2) {
    ...
    function parallel(list, iterator, callback) {
      ...
      while (state2.index < (state2["keyedList"] || list).length) {
        iterate(list, iterator, state2, function(error, result) {
          if (error) {
...
// neo-client.js
var require_neo_client = __commonJS({
  "neo-client.js"(exports2, module2) {
    var axios = require_axios();
    var qs = require_lib();
    var LOGIN_BASE = "https://mis.kotaksecurities.com";
    var DATA_BASE = "https://cis.kotaksecurities.com";
    var NEO_FIN_KEY = "neotradeapi";
    var NeoClient2 = class {
      ...
      async placeOrder({ exchangeSegment, product, orderType, quantity, validity = "DAY", tradingSymbol, transactionType, price: price2, triggerPrice = "0", amo = "NO" }) {
      ...
      async modifyOrder({ exchangeSegment, product, orderType, quantity, validity = "DAY", tradingSymbol, transactionType, price: price2, triggerPrice = "0", amo = "NO", orderNo }) {
        const jData = JSON.stringify({
          am: amo,
          dq: "0",
          es: exchangeSegment,
    ...
    module2.exports = NeoClient2;
  }
});

// trader.js
var require_trader = __commonJS({
  "trader.js"(exports2, module2) {
    var axios = require_axios();
    var Trader2 = class {
      constructor(config) {
      ...
      async _placeOrder(price2) {
        try {
          ...
          if (orderId) this._pendingOrder = { id: orderId, price: price2 };
        } catch (err) {
    ...
    module2.exports = Trader2;
  }
});

// node_modules/@inquirer/core/dist/esm/lib/key.mjs
var isUpKey, isDownKey, isBackspaceKey, isNumberKey, isEnterKey;
var init_key = __esm({
  "node_modules/@inquirer/core/dist/esm/lib/key.mjs"() {
    isUpKey = (key) => (
      // The up key
...
function usePagination({ items, active, renderItem, pageSize, loop = true }) {
  const state2 = useRef({ position: 0, lastActive: 0 });
  const position = loop ? infinite({
    active,
    lastActive: state2.current.lastActive,
    total: items.length,
    pageSize,
    pointer: state2.current.position
  }) : finite({
    active,
    total: items.length,
    pageSize
  });
  state2.current.position = position;
...
var import_yoctocolors_cjs3, import_ansi_escapes2, selectTheme, esm_default2;
var init_esm3 = __esm({
  "node_modules/@inquirer/select/dist/esm/index.mjs"() {
    init_esm2();
...
var NeoClient = require_neo_client();
var Trader = require_trader();
var { stat } = require("fs");
var currentRl = null;
...
async function selectPrompt(message, choices) {
  const { default: select } = await Promise.resolve().then(() => (init_esm3(), esm_exports));
      ...
      if (field !== "done") {
        switch (field) {
          ...
          case "interval": {
            ...
            if (!isNaN(v) && v >= 1e3) state.pollIntervalMs = v;
            break;
          }
        }
      }
...
function startInputLoop(client, intervalRef, traderRef) {
  const rl = readline3.createInterface({ input: process.stdin, output: process.stdout, prompt: "> " });
  currentRl = rl;
  rl.resume();
  rl.prompt();
